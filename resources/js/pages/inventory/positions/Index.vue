...
const breadcrumbs: BreadcrumbItem[] = [
    ...
    { title: 'Posição por depósito', href: '/inventory/positions' },
]
...
const exportParams = computed(() => {
    ...
    return {
        csv: query ? `/inventory/positions/export/csv?${query}` : '/inventory/positions/export/csv',
        pdf: query ? `/inventory/positions/export/pdf?${query}` : '/inventory/positions/export/pdf',
    }
})
</script>

<template>
    <Head title="Posição por depósito" />
    ...
    <AppLayout :breadcrumbs="breadcrumbs">
        <div class="flex flex-col gap-6 p-4 sm:p-6">
            ...
            >
                ...
                <div class="relative flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
                    <Heading
                        ...
                        description="Consulte o saldo atual dos produtos em cada depósito."
                        :icon="Boxes"
                    />

                    <div class="flex flex-col gap-3 sm:flex-row">
                        <Can permission="inventory.exportProductStock">
                        ...
                        <Can permission="inventory.viewInventoryPosition">
                            <Link href="/inventory/positions/consolidated" class="w-full sm:w-auto">
            ...
            <div class="rounded-xl border bg-card/50 p-4 shadow-sm">
                <form class="grid gap-3 md:grid-cols-[260px_1fr] xl:grid-cols-[260px_1fr_auto]" @submit.prevent="submitSearch">
                    <select
                        v-model="warehouseId"
                    ...
                    <Button type="submit" variant="outline" class="w-full xl:w-auto">
                    ...
                    <table class="min-w-[860px] w-full text-sm">
                        <thead class="bg-muted/50">
                            <tr>
                                ...
                                <th class="px-4 py-3 text-left whitespace-nowrap">Saldo</th>
                            </tr>
                        </thead>
                        ...
                        <tbody>
                            <tr
                                ...
                                class="border-t"
                            >
                                <td class="px-4 py-3 align-top">{{ position.warehouse_name || '—' }}</td>
                                <td class="px-4 py-3 align-top">{{ position.product_name || '—' }}</td>
                                <td class="px-4 py-3 align-top">{{ position.quantity }}</td>
                            </tr>
