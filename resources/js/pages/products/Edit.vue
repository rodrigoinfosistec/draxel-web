...
const breadcrumbs: BreadcrumbItem[] = [
    ...
    { title: 'Editar produto', href: `/products/${props.product.id}/edit` },
]
...
const form = useForm({
    ...
    ncm_code: props.product.ncm_code ?? '',
    product_category_id: props.product.product_category_id,
    unit_of_measure_id: props.product.unit_of_measure_id,
    brand_id: props.product.brand_id ?? '',
    description: props.product.description ?? '',
    purchase_description: props.product.purchase_description ?? '',
    tracks_stock: props.product.tracks_stock,
...
async function destroy() {
    const confirmed = await useConfirm({
        ...
        text: 'Essa ação removerá o produto permanentemente.',
                ...
                <section class="space-y-4">
                    <div>
                        ...
                        <p class="text-sm text-muted-foreground">
                            Atualize os dados básicos do produto.
                        </p>
                    </div>
