...
const breadcrumbs: BreadcrumbItem[] = [
    ...
    {
        title: 'Editar cargo',
        href: `/positions/${props.position.id}/edit`,
    },
]
...
async function destroy() {
    const confirmed = await useConfirm({
        title: 'Excluir cargo?',
        text: 'Essa ação removerá o cargo permanentemente.',
    ...
    form.delete(`/positions/${props.position.id}`)
}
</script>
                ...
                <section class="space-y-4">
                    <div>
                        ...
                        <p class="text-sm text-muted-foreground">
                            Atualize os dados básicos do cargo.
                        </p>
                    </div>
