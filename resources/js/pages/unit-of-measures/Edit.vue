...
const breadcrumbs: BreadcrumbItem[] = [
    ...
    { title: 'Editar unidade', href: `/unit-of-measures/${props.unitOfMeasure.id}/edit` },
]

const form = useForm({
    name: props.unitOfMeasure.name,
    symbol: props.unitOfMeasure.symbol,
    description: props.unitOfMeasure.description ?? '',
    is_active: props.unitOfMeasure.is_active,
})

function submit() {
    form.put(`/unit-of-measures/${props.unitOfMeasure.id}`, {
        preserveState: false,
...
async function destroy() {
    const confirmed = await useConfirm({
        ...
        text: 'Essa ação removerá a unidade permanentemente.',
    ...
    router.delete(`/unit-of-measures/${props.unitOfMeasure.id}`)
}
</script>
            ...
            >
                ...
                <div class="relative flex items-start justify-between gap-4">
                    <Heading
                        ...
                        description="Atualize os dados da unidade."
                        :icon="Ruler"
                    />
            ...
            >
                <section class="space-y-4">
                    <div>
                        ...
                        <p class="text-sm text-muted-foreground">
                            Atualize os dados básicos da unidade.
                        </p>
                    </div>
                ...
                >
                    <div class="flex flex-col gap-3 sm:flex-row">
                        <Can permission="unitOfMeasures.delete">
                            <Button
                                type="button"
                                variant="destructive"
