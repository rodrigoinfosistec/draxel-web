...
import { ArrowLeft, Plus, Search, ShoppingCart, Trash2 } from 'lucide-vue-next'
...
const breadcrumbs: BreadcrumbItem[] = [
    ...
    { title: 'Novo pedido', href: '/order/orders/create' },
]
        ...
        <div class="flex flex-col gap-6 p-4 sm:p-6">
            <div class="relative overflow-hidden rounded-2xl border bg-card/40 p-4 shadow-sm backdrop-blur-[1px] sm:p-5">
                ...
                <div class="relative flex items-start justify-between gap-4">
                    <Heading
                        title="Novo pedido"
                        description="Cadastre um novo pedido e organize a lista de itens com agilidade."
                        :icon="ShoppingCart"
                    />
                    ...
                    <div class="space-y-4">
                        <div>
                            ...
                            <p class="text-sm text-muted-foreground">
                                Informe os dados principais do pedido.
                            </p>
                        </div>
                    ...
                    <div class="space-y-5">
                        ...
                        <div class="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                            <div class="text-sm text-muted-foreground">
                                Ajuste quantidades e observações diretamente na lista.
                            </div>
