...
const breadcrumbs: BreadcrumbItem[] = [
    ...
    { title: 'Editar feriado', href: `/holidays/${props.holiday.id}/edit` },
]
...
async function destroy() {
    const confirmed = await useConfirm({
        ...
        text: 'Essa ação removerá o feriado permanentemente.',
    ...
    form.delete(`/holidays/${props.holiday.id}`)
}
</script>

<template>
    <Head title="Editar feriado" />
            ...
            >
                ...
                <div class="relative flex items-start justify-between gap-4">
                    <Heading
                        ...
                        description="Atualize os dados do feriado."
                        :icon="CalendarDays"
                    />
                ...
                <section class="space-y-4">
                    <div>
                        ...
                        <p class="text-sm text-muted-foreground">
                            Atualize os dados básicos do feriado.
                        </p>
                    </div>
