...
class UpdateProductSupplierReferenceRequest extends FormRequest
{
    public function authorize(): bool
    {
        /** @var \App\Models\ProductSupplierReference $supplierProductReference */
        $supplierProductReference = $this->route('supplierProductReference');

        return $this->user()->can('update', $supplierProductReference);
    }
        ...
        return [
            ...
            'product_id' => [
                ...
                Rule::unique('product_supplier_references', 'product_id')
                    ...
                    ->ignore($supplierProductReference->id),
            ],
